...
export default function EntityTetrahedron(props, ref) {
  ...
  return (
    <mesh
      ...
      <tetrahedronGeometry args={params} />
      {props.material && <EntityMaterialParse {...props} />}
    </mesh>
  )
}

export const EntityTetrahedronRef = React.forwardRef(EntityTetrahedron);